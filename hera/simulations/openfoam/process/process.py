...
class process():
    ...
    def runCase(self, data, wrfZ=None, Time=None, wrfPath=None, dirName="OFsimulation", newPath=None, dxdy=100, zMax=1000, xCells=50, yCells=50, zCells=50):
        """
        runs an OF simulation
