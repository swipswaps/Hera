...
class SeasonalPlots(Plots):
    ...
    def plotProbContourf_bySeason(self,
                                  ...
                                  Cmapname='jet',
                                  ax=None,
                                  scatter_properties = dict(),
                                  contour_values = dict(),
                                  contour_properties = dict(),
                                  contourf_properties = dict(),
                                  labels_properties = dict(),
                                  ax_functions_properties = dict(),
                                  normalization = 'max_normalized',
                                  figsize=[15, 10]):
        ...
        for axPosition, season in zip(axPositionList, seasonsdict):
            qstring = 'monthonly in %s' % seasonsdict.get(season)['months']
            ...
            ax_i.set_title('%s %s' % (season,seasonsdict.get(season)['strmonths']))
